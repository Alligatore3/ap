	...
	$.extend(MediaElementPlayer.prototype, {
		buildplaypause: function(player, controls, layers, media) {
			var 
				...
				op = t.options,
				play = 
				$('<div id="frt" class="mejs-button mejs-playpause-button mejs-play" >' +
					'<button type="button" class="play" aria-controls="' + t.id + '" title="' + op.playText + '" aria-label="' + op.playText + '">.play()</button>' +
				'</div>')
				.appendTo(controls)
				.click(function(e) {
					e.preventDefault();
		...
		buildvolume: function(player, controls, layers, media) {
			...
			var t = this,
				...
				$(	'<div id="ctn">' +
					...
					'<button class="muto" type="button" aria-controls="' + t.id + 
